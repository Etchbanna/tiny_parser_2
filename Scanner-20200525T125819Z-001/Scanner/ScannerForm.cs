...
namespace Scanner
{
...

    {
        ...
        static extern bool sysem(string str);
        ...
        public void expFromIfStmt()
        {
            ...
            if (CurrentToken == "<" || CurrentToken == "=")
            {
                comparison_opFromIfStmt();
                SyntaxTree.Nodes.Remove(factor_2);
                operator_.Nodes.Add(factor_2);
                simple_expFromIfStmt();
                SyntaxTree.Nodes.Remove(factor_2);
                operator_.Nodes.Add(factor_2);
            }
        ...
        public void comparison_opFromIfStmt()
        {
        ...
        public void comparison_opFromWriteStmt()
        {
        ...
        public void simple_expFromAssignStmt()
        {
            ...
            while (CurrentToken == "+" || CurrentToken == "-" || CurrentToken == "–")
            {
                ...
                if (operator_.Parent == null)
                {
                    ...
                    {
                        temp = operator_;
                        TreeNode imaginarynode = new TreeNode("");
                        imaginarynode.Nodes.Add(operator_);

                    }
                }
                

                else if (operator_.Parent != assignstmt)
                {

                    temp = operator_;
                    operator_ = new TreeNode("Operator (" + CurrentToken + ")");
                    SyntaxTree.Nodes.Remove(operator_);
                    temp.Nodes.Add(operator_);
                    SyntaxTree.Nodes.Remove(factor_2);
                    operator_.Nodes.Add(factor_2);
                    addopFromAssignStmt();
                    termFromAssignStmt();
        ...
        public void simple_expFromIfStmt()
        {
            ...
            while (CurrentToken == "+" || CurrentToken == "-" || CurrentToken == "–")
            {
                TreeNode temp = operator_;
                
                if ((SyntaxTree.Nodes.Contains(operator_))==true)
                {
                    operator_ = new TreeNode("Operator (" + CurrentToken + ")");
                    ifstmt.Nodes.Add(operator_);
                    SyntaxTree.Nodes.Remove(factor_2);
        ...
        public void simple_expFromWriteStmt()
        {
            ...
            while (CurrentToken == "+" || CurrentToken == "-" || CurrentToken == "–")
            {
                ...
                {
                    operator_ = temp;
                    temp = new TreeNode("Operator (" + CurrentToken + ")");
                    operator_.Nodes.Add(temp);
                    SyntaxTree.Nodes.Remove(factor_2);
                    temp.Nodes.Add(factor_2);
                    addopFromWriteStmt();
                    termFromWriteStmt();
        ...
        public void addopFromWriteStmt()
        {
            if (CurrentToken == "+")
            {
        ...
        public void addopFromRepeatStmt()
        {
            if (CurrentToken == "+")
            {
        ...
        public void mulopFromWriteStmt()
        {
            if (CurrentToken == "*")
            {
        ...
        public void mulopFromRepeatStmt()
        {
            if (CurrentToken == "*")
            {
                operator_ = new TreeNode("Operator (" + CurrentToken + ")");
        ...
        public void factorFromWriteStmt()
        {
            if (state == nameofState.NUMBER)
            {
                     ...
                     || CurrentToken == "<")
                {
                    ...
                    if((writestmt.Nodes.Contains(operator_))==false)
